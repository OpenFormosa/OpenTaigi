...
- 真人語句聽力闖關與語詞配對遊戲
- 裝置內保存積分、目前連勝、最高連勝與答題數
- 教學模式會依拼音、語詞、語句、文章重新編排，不照搬 PDF 版面
- 拼音與文章音檔直接嵌入對應音節、詞例或段落，不另做播放牆
- 桌機側欄、頁首換頁與手機底部導覽共用同一套教材體驗設計系統
- 語詞頁整合詞頭、台羅、華語、例詞與 A／B 真人音檔
...
介面規則與驗收標準見 [`docs/design-system.md`](docs/design-system.md)。
